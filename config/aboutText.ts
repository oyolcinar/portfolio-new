export const aboutText = `I remember the day I talked with my father on one of those lazy holiday weekends. I was enthusiastically describing a usual tech-marvel when I noticed how his eyes trailed off in a kind and yet pitiful smile. As if he was trying to say "Son, this is why we went out of our way for you to get educated as well as you did. To be part of this generation, not to gawk at its marvels."
...
I found solace in the challenge. Also noticed I barely knew anyone with tech background despite my eclectic social circle. So it became a game with no cheats and no tutorials. I took refuge in the fact that "I knew how to learn first" as the Bene Gesserits would say. I also learned my limitations as a human being. That it's a vast ocean that you can only drop anchor in its familiar and pleasant tides. And so I did.
