...
export default function ShutdownDialog() {
  ...
  const { close, isActive, focus } = useWindowManager();
  const active = isActive('shutdown');
  ...
  return (
    <div
      className='absolute z-[100] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2'
      style={containerStyle}
      onMouseDown={() => focus('shutdown')}
    >
      <div
      ...
      >
        ...
        >
          ...
          <div className='ml-0.5' data-no-drag>
            <Image
              alt='close'
              src={closeIcon}
              height={23}
          ...
          <div className='text-[0.55rem]'>
            ...
            <form className='mt-[10px]' onSubmit={handleSubmit}>
              <div className='mb-[10px]'>
                ...
                <label
                  htmlFor='choice1'
                  className='ml-[5px] hover:outline-dashed hover:outline-1 hover:outline-win-darker hover:outline-offset-2 cursor-pointer'
                >
